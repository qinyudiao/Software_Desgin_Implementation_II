...
public class Filter {
    ...
    public static List<Tweets> writtenBy(List<Tweets> tweets, String username) {
        ...
        for(Tweets tweet : tweets) {
        	if (tweet.getName().equalsIgnoreCase(username))
    ...
    public static List<Tweets> inTimespan(List<Tweets> tweets, Timespan timespan) {
        ...
        for(Tweets tweet : tweets) {
        	...
        	boolean afterStart = date.compareTo(timespan.getStart()) == 1 || date.compareTo(timespan.getStart()) == 0;
        	
        	boolean beforeEnd = date.compareTo(timespan.getEnd()) ==  -1 || date.compareTo(timespan.getEnd()) ==  0;
